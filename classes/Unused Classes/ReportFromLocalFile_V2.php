...
/*
    ...
    The input from the user contains onlt the path to the result file.
    
    This version uses the Fpdf class to create the output report
*/
    require 'Base.php';
    require 'classes/pdftableReport.php';  
      
      
class ReportFromLocalFile_V2 extends Base{
    var $data;
    ...
    {
        $this->data['dateCheck'] = false; //Suppress the date check in the pdf report class
